      ...
      <div class="w">
        <div class="fl">
          <div class="item">
            <router-link to="/news">
              <img
                src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1597608185889&di=640e1a4f43bd8f783bbf30066604c976&imgtype=0&src=http%3A%2F%2Fa3.att.hudong.com%2F14%2F75%2F01300000164186121366756803686.jpg"
                alt=""
              />
              <div class="title">
                <p class="nowrap">
                  三一SCC40000A“红色巨无霸”完成首吊，中国力量再登世界巅峰！
                </p>
              </div>
            </router-link>
          </div>
